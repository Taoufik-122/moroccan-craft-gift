...
const Auth = () => {
  ...
  // إعادة التوجيه إذا كان المستخدم مسجّل الدخول
  useEffect(() => {
    if (user) navigate('/');
  }, [user, navigate]);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.error) {
        ...
        navigate('/'); // التنقل بعد نجاح تسجيل الدخول أو التسجيل
      }
    } catch {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      // بعد إعادة التوجيه من Google، useEffect سيقوم بالتنقل تلقائياً
    } catch {
